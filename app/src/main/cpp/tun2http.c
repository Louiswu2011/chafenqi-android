...
Java_com_nltv_chafenqi_updater_ChafenqiProxy_jni_1init(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_nltv_chafenqi_updater_ChafenqiProxy_jni_1start(
...
JNIEXPORT void JNICALL
Java_com_nltv_chafenqi_updater_ChafenqiProxy_jni_1stop(
...
Java_com_nltv_chafenqi_updater_ChafenqiProxy_jni_1get_1mtu(JNIEnv *env, jobject instance) {
    return get_mtu();
}


JNIEXPORT void JNICALL
Java_com_nltv_chafenqi_updater_ChafenqiProxy_jni_1done(JNIEnv *env, jobject instance) {
...
Java_com_nltv_chafenqi_updater_Util_jni_1getprop(JNIEnv *env, jclass type, jstring name_) {
